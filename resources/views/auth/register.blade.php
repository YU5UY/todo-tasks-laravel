                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @else
                                    <span class="small font-weight-light text-info">{{__("messages.name.note")}}</span>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @else
                                    <span class="font-weight-light small text-info">{{__("messages.username.note")}}</span>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @else
                                <span class="font-weight-light small text-info">{{__("messages.password.note")}}</span>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a class="btn btn-link text-info" href="{{ route('login') }}">
                                   {{__("messages.login")}} {{__("messages.question")}}
                                </a>
                            </div>
                        </div>
                    </form>
